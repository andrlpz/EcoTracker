...
import { mapOutline, informationCircleOutline, personCircleOutline, colorFillOutline } from 'ionicons/icons';
...
const Tabs: React.FC = () => {
  ...
  return (
    <IonTabs>
      ...
      <Route exact path="/tabs/IA" component={IA} />
    ...
    <IonTabBar slot="bottom" className="custom-tab-bar">
      ...
      <IonTabButton tab="IA" href="/tabs/IA">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640" width="32" height="32" fill="white">
