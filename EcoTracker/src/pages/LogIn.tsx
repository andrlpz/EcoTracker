...
function LogIn() {
  return (
    <IonPage>
      ...
      <div> 
      <IonCheckbox className='remember'>Remember me</IonCheckbox>
      <a className='forgotPswd' href="#">Forgot password?</a>
      </div>
      <div>
        <IonButton className='logIn'>Log in</IonButton>
      </div>
      <p className='txlog'>Log in with</p>
      <div>
        <IonButton className='google'><img src="../../assets/google.png" width='50px' height='50px'/></IonButton>
      </div>
